    ...
    <div id="brand-story-page" className="min-h-screen bg-[#FAF7F2] pb-24">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        <div className="space-y-5 text-base sm:text-lg leading-relaxed text-[#1C1611]">
          <blockquote className="border-l-3 border-[#8C2223] pl-4 italic text-lg sm:text-xl font-medium text-[#1C1611]">
        ...
        <div className="rounded-xl overflow-hidden border border-[#E7DFD4] bg-[#251E17]">
          <div className="aspect-16/9 relative">
            ...
            <div className="absolute bottom-4 left-4 right-4 text-white text-xs sm:text-sm">
              ...
              <p className="text-[#D4C7BA] text-xs">Founder and head chef at Rinchen&apos;s Momo.</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 rounded-xl bg-white border border-[#E7DFD4] space-y-3">
        ...
        <div className="space-y-6">
          ...
          <div className="relative border-l-2 border-[#E7DFD4] ml-3 pl-6 space-y-7">
            {STORY_MILESTONES.map((mile, idx) => (
              <div key={idx} className="relative">
                {/* Marker point */}
                <span className="absolute -left-[31px] top-1 w-3.5 h-3.5 rounded-full bg-white border-2 border-[#8C2223]" />
        ...
        <div className="p-6 sm:p-8 rounded-xl bg-[#1C1611] text-[#FAF7F2] flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2.5 rounded-lg bg-[#F5C842] hover:bg-[#E8BC38] text-[#1C1611] text-xs font-semibold transition-colors cursor-pointer"
            >
              Find Outlets
            </button>
            <button
